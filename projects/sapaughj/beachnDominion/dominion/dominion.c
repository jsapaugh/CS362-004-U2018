...
void smithyCard(int currentPlayer, int handPos, struct gameState *state)
{
    int i;
    //+3 Cards
    // Added bug here, restrict player to add 4 cards to their hand rather than correct 3
    for (i = 0; i < 4; i++)
    {
        drawCard(currentPlayer, state);
    }
...
void villageCard(int currentPlayer, int handPos, struct gameState *state)
{
    ...
    //+2 Actions
    // Added bug here, adds 3 to players action count vs correct 2
...
void council_roomCard(int currentPlayer, int handPos, struct gameState *state)
{
    int i;
    //+4 Cards
    // Added bug here, add 3 cards to hand vs correct 4
    for (i = 0; i < 3; i++)
    {
        drawCard(currentPlayer, state);
    }
